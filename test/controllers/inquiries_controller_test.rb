...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { email: @inquiry.email, firstname: @inquiry.firstname, lastname: @inquiry.lastname, message: @inquiry.message } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { email: @inquiry.email, firstname: @inquiry.firstname, lastname: @inquiry.lastname, message: @inquiry.message } }
